...
class TrainLoop:
    ...
    def compile_and_fit(self, validation_freq=10, verbose=1, new_callbacks=None, ):
    ...
    def save_model(self):
        ...
        saved_model_name = os.path.join(saved_model_dir, self.model_name+'_time={}.h5'.format(strftime('%Y%m%d_%H%M')))
    ...
    def save_weights(self):
        ...
        saved_weights_name = os.path.join(saved_weight_dir, self.model_name+'_time={}.h5'.format(strftime('%Y%m%d_%H%M')))
